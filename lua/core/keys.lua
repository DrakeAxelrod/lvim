...
M.leadermaps = {
  ...
  { "<leader>Th", ":new | :term<CR>", description = "Horizontal split", opts = opts },
  { "<leader>Tv", ":vnew | :term<CR>", description = "Vertical split", opts = opts },
  { "<leader>Tt", ":vnew | :term htop<CR>", description = "Htop", opts = opts },
  { "<leader>Tn", ":vnew | :term node<CR>", description = "Node", opts = opts },
  { "<leader>Tp", ":vnew | :term python<CR>", description = "Python", opts = opts },
  { "<leader>Tg", ":vnew | :term lazygit<CR>", description = "LazyGit", opts = opts },
